...
```shell
git clone https://github.com/<your-name-here>/typescript-sample-project
cd typescript-sample-project
pnpm install
```
...
Note that [console-fail-test](https://github.com/rubenqba/console-fail-test) is enabled for all test runs.
...
```shell
node ../typescript-sample-project/lib/hydrate/index.js -- description "Hooray, trying things out locally."
```
